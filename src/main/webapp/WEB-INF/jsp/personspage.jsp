...
<p>
You are now logged in as: <%= request.getUserPrincipal().getName() %>.
</p>
</security:authorize>

<security:authorize access="hasRole('ROLE_ADMIN')">
<p>
This sentence will only be visible to admins.
</p>
</security:authorize>
...
<form name="input" action="/spring-security-ldap/danny/person/persons/search" method="post">
Persons first name: <input type="text" name="searchTerm" id="searchTerm"/>
<input type="submit" value="Search" />
</form> 
<p><a href="/spring-security-ldap/danny/person/personsajaxpage">Persons AJAX</a></p>
<p><br />
